import { createStore, combineReducers } from 'redux'  // add applyMiddleware if using bluebird or thunk
...
export default function(data) {
  ...
  var finalCreateStore = applyMiddleware(promiseMiddleware)(createStore) // LOOK AT HOW TO NOT USE MIDDLEWARE
